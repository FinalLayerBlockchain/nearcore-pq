...
pub enum Parameter {
    ...
    // Flag to enable PQC verify host functions (mldsa_verify, fndsa_verify, slhdsa_verify)
    PqcHostFns,

    // Flag to keep ed25519_verify available (false on PQC chain v1000+)
    Ed25519VerifyAvailable,
}
