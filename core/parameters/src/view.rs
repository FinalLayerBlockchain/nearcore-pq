...
pub struct VMConfigView {
    ...
    /// See [VMConfig::pqc_host_fns](crate::vm::Config::pqc_host_fns).
    pub pqc_host_fns: bool,
    /// See [VMConfig::ed25519_verify_available](crate::vm::Config::ed25519_verify_available).
    pub ed25519_verify_available: bool,
...
impl From<crate::vm::Config> for VMConfigView {
    fn from(config: crate::vm::Config) -> Self {
        Self {
            ...
            pqc_host_fns: config.pqc_host_fns,
            ed25519_verify_available: config.ed25519_verify_available,
        }
    }
}
...
impl From<VMConfigView> for crate::vm::Config {
    fn from(view: VMConfigView) -> Self {
        Self {
            ...
            pqc_host_fns: view.pqc_host_fns,
            ed25519_verify_available: view.ed25519_verify_available,
        }
    }
}
