...
impl ProtocolFeature {
    ...
    pub const fn protocol_version(self) -> ProtocolVersion {
        match self {
            ...
            // FL: Disabled for Final Layer — set above our max protocol version.
            ProtocolFeature::Spice => 10000,
...
const STABLE_PROTOCOL_VERSION: ProtocolVersion = 1003; // PQC gas rebalance: ML-DSA 3.0T, SLH-DSA 8.0T
