...
imports! {
    ...
    #[ed25519_verify_available] ed25519_verify<[sig_len: u64,
        sig_ptr: u64,
        msg_len: u64,
        msg_ptr: u64,
        pub_key_len: u64,
    ...
    // #############################################
    // # PQC Verify (post-quantum, protocol >= 1000) #
    // #############################################
    #[pqc_host_fns] mldsa_verify<[sig_len: u64, sig_ptr: u64, msg_len: u64, msg_ptr: u64, pk_ptr: u64] -> [u64]>,
    #[pqc_host_fns] fndsa_verify<[sig_len: u64, sig_ptr: u64, msg_len: u64, msg_ptr: u64, pk_ptr: u64] -> [u64]>,
    #[pqc_host_fns] slhdsa_verify<[sig_len: u64, sig_ptr: u64, msg_len: u64, msg_ptr: u64, pk_ptr: u64] -> [u64]>,
    // #####################
    // # Miscellaneous API #
    // #####################
