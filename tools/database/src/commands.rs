...
use crate::reset_head::ResetHeadCommand;
...
enum SubCommand {
    ...
    /// Reset chain HEAD, FINAL_HEAD, HEADER_HEAD to a specific block
    ResetHead(ResetHeadCommand),
...
impl DatabaseCommand {
    pub fn run(
        ...
        match &self.subcmd {
            ...
            SubCommand::ResetHead(cmd) => cmd.run(home, genesis_validation),
